...
const Card = () => {
  return (
    <div className='flex flex-col gap-[8px] justify-center items-center text-white lg:w-[124px] xl:w-[160px] lg:h-[196px] xl:h-[240px] rounded-[10.5px] py-[24px] px-[12px] bg-gradient-to-b from-[#9A55FF] to-[57.79%] to-[#D355FF]'>
        <div className=' h-[143px] flex justify-center items-center '>
            <DoughnutChart data={data} text="68%" color="White" textStyle="bold 24px albert-sans"/>
        </div>
