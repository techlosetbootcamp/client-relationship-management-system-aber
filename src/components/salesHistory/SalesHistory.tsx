...
const SalesHistory = () => {
  return (
    <CardWrapper width="md:w-[344.45px] xl:w-[415px]" height="md:h-[265.6px] xl:h-[320px]" flexDirection="flex-col flex-1">
      ...
      <p className="font-[600] xs:text-[10px] xl:text-[12px] xs:leading-[15px] xl:leading-[18px] font-albertSans text-mediumGray">RECENT</p>
